...
# V11.0 — Shared helpers extracted to break circular import with
# gas_doc_proiect_complet. We re-export them so older callers that do
# `from gas_doc_templates import COMPANY, _get, ...` continue to work.
from gas_doc_utils import (  # noqa: F401
    COMPANY,
    _today_ro,
    _get,
    _truthy,
...
# _save is re-exported from gas_doc_utils above.
