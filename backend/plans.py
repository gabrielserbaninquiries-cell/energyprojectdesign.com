...
PLANS: Dict[str, Dict] = {
    ...
    "vgd": {
        ...
        "price_eur": 338, "currency": "eur", "currency_label": "EUR / lună (fără TVA)",
    ...
    "rte": {
        ...
        "price_eur": 298, "currency": "eur", "currency_label": "EUR / lună (fără TVA)",
    ...
    "societate": {
        "id": "societate", "name": "Societate", "label": "Societate (1 PC)",
        "price_eur": 798, "currency": "eur", "currency_label": "EUR / lună (fără TVA)",
        "tagline": "Acces total pentru 1 PC (device binding) — toate departamentele unei firme (proiectant + executant + avize + ofertare + contabilitate). 150 proiecte/lună.",
        ...
        "value_props": [
            "150 proiecte / lună · 1500 documente generabile",
            "1 PC autorizat (device binding) — protecție anti-partajare",
    ...
    "mass_production": {
        ...
        "tagline": "Pentru societăți cu volum foarte mare de lucrări — 300 proiecte/lună. Acces total + prioritate suport + API direct.",
        ...
        "value_props": [
            "300 proiecte / lună (dublu față de Societate)",
            "5000 documente / lună",
            "1 PC autorizat (device binding) — protecție anti-partajare",
